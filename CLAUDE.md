...
- Current schema version: **4** (apps must always write v4, but support reading v1/v2/v3 via migration)
...
- **Instrument categories**: `Piano`, `Mallet`, `Strings`, `Bass`, `Drums`, `Soundfont`
